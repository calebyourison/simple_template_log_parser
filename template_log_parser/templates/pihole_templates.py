...
# FTL
pihole_ftl_blocking_status = "{time} {server_name} piFTL [{timestamp} {ids}] Blocking status {blocking_status}"
...
pihole_ftl_reloading_dns_cache = "{time} {server_name} piFTL [{timestamp} {ids}] Reloading DNS cache"
pihole_ftl_stats = "{time} {server_name} piFTL [{timestamp} {ids}]  -> {category}: {number}"
...
pi_ftl_general_message_with_category = "{time} {server_name} piFTL [{timestamp} {ids}]    {category}: {message}"
pihole_ftl_general_message = "{time} {server_name} pihole-FTL[{id}]: [{timestamp} {ids}] {message}"
...
pihole_ftl = {
    ...
    "Reloading DNS cache": [pihole_ftl_reloading_dns_cache, 4, "ftl_reloading_dns_cache"],
    ...
    " pihole-FTL": [pihole_ftl_general_message_with_category, 7, "ftl_general_category_message"],
    " piFTL": [pi_ftl_general_message_with_category, 6, "pi_ftl_general_category_message"],
