...
creating_2 = "{time} T:{T} {level} <{category}>: creating {info}"
...
instancing = "{time} T:{T} {level} <{category}>: Instancing {info}"
...
starting = "{time} T:{T} {level} <{category}>: starting {info}"
...
load_2 = "{time} T:{T} {level} <{category}>: load {info}"
